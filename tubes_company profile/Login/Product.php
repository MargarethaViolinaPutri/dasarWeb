            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <H2>PRODUCT WISE PACK SURABAYA </H2>
                    </div>
                    <div class="card-body">
                        <a href="insert_product.html" class="btn btn-md btn-success" style="margin-bottom: 10px">ADD
                            PRODUCT</a>
                        <a href="cetak_product.php" class="btn btn-md btn-success" style="margin-bottom: 10px">CETAK
                            PRODUCT</a>
                  ...
                  ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="editProduct.php?id_product=<?php echo $row['id_product'];?>"
                                            class="btn btn-sm btn-primary">EDIT</a>
                                        <a href="deleteProduct.php?id_product=<?php echo $row['id_product']; ?>"
